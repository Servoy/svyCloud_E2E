...
defineSupportCode(function ({ After, Before, registerHandler }) {
    ...
    After({ timeout: 60 * 1000 }, function (scenario, callback) {
        if (scenario.isFailed()) {
            ...
            browser.takeScreenshot().then(function (buffer) {
                ...
                console.log('Unable to create a screenshot: ' + error.message);
            });
        } else {
    ...
    registerHandler('AfterFeatures', function (features, callback) {
        ...
        function getOptions(theme) {
            return {
                name: 'E2E Result Report', //this tests for the sanitized hyperlinks on report, otherwise this should be plain text english
                theme: theme,
                ...
                jsonDir: 'reports/cucumber_reports'
                /*metadata: {
                    'App Version': '0.3.2',
